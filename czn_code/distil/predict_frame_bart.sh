#!/bin/bash
#SBATCH -J b_draw                              # 作业名为 test
#SBATCH -o ./out/0511/roberta_bart_5e6_draw.out                           # 屏幕上的输出文件重定向到 test.out
...
python predict_frame.py \
    ...
    --train_data /users5/znchen/distil/res/facebookbartlarge/R0train.res.r0.jsonl\
    --test_data /users5/znchen/distil/res/facebookbartlarge/R0.res.test.jsonl\
    --dev_data /users5/znchen/distil/res/facebookbartlarge/R0.res.test.jsonl \
    --epochs $epoch \
    --test\
