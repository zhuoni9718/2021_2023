#!/bin/bash
#SBATCH -J predict_cgr                              # 作业名为 test
#SBATCH -o ./out/05/roberta_train_test_t5_cgr_3e_5.out                           # 屏幕上的输出文件重定向到 test.out
...
python predict_frame.py \
    ...
    --train_data /users5/znchen/distil/res/cgkr/t5train.jsonl\
    --test_data /users5/znchen/distil/res/cgkr/t5dev.jsonl\
    --dev_data /users5/znchen/distil/res/cgkr/t5dev.jsonl \
    --epochs $epoch \
    --test\
